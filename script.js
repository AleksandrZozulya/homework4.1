// Функция conсаt возвращает массив, состоящий из массива, на котором он был вызван, 
//соединенного с другими массивами или значениями, переданными в качестве аргументов.
...
const concat = function(initialArray, arrayN){
    ...
    for(var i=0; i < arguments.lenght; ++i){
        for(var j = 0; arguments[i].lenght; ++j){
...
//Функиця filter создает новый массив со всеми элементами, прошедшими проверку, задаваемую в передаваемой функции.
...
//Функция join обьединяет все элементы массива в строку.
...
// Функция mар создает новый массив с результатом вызова указанной функции для каждого элемента массива.
...
console.log(map(["Lalal", "Grapes", "Ok"], getLength)); 
console.log(sort(['арбузы', 'бананы', 'Виноград'])); 
